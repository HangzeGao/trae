...
/* CTR mode (GCM uses ctr32) */
void aes_ctr32_encrypt(const AES_KEY *key, uint8_t ctr[16], const uint8_t *in, size_t inlen, uint8_t *out);

/* GCM mode */
#define AES_GCM_IV_MIN_SIZE		1
#define AES_GCM_IV_MAX_SIZE		64
#define AES_GCM_IV_DEFAULT_SIZE	12
#define AES_GCM_MIN_AAD_SIZE		0
#define AES_GCM_MAX_AAD_SIZE		((1<<24))
#define AES_GCM_MIN_PLAINTEXT_SIZE	0
#define AES_GCM_MAX_TAG_SIZE		16
#define AES_GCM_MIN_TAG_SIZE		12
#define AES_GCM_DEFAULT_TAG_SIZE	16
