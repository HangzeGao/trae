 ...
 *
 *  SM4 (GB/T 32907-2016) - block cipher
 */
...
/* inc32() in nist-sp800-38d: increment low 32 bits only */
...
/* General ctr32_encrypt: handles arbitrary byte lengths */
